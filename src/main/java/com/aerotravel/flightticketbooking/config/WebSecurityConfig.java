    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        ...
                        .requestMatchers("/swagger-ui/**", "/swagger-ui.html", "/swagger-ui/", "/swagger-ui", "/v3/api-docs/**", "/v3/api-docs.yaml", "/v3/api-docs-compact", "/v3/api-docs-compact.yaml", "/database/ftb_mysql.sql", "/swagger-resources/**", "/webjars/**").permitAll()
